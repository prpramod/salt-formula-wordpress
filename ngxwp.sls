...
update_wp_config:
  cmd.run:
    - name: sed -i "s/define( 'DB_NAME', 'database_name_here' );/define( 'DB_NAME', 'wordpress' );/g; s/define( 'DB_USER', 'username_here' );/define( 'DB_USER', 'pramod' );/g; s/define( 'DB_PASSWORD', 'password_here' );/define( 'DB_PASSWORD', 'metrix@123' );/g; s/define( 'DB_HOST', 'localhost' );/define( 'DB_HOST', 'localhost' );/g" wp-config-sample.php
